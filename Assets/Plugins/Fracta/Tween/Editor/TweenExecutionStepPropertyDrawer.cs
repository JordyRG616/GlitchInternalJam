...
public class TweenExecutionStepPropertyDrawer : PropertyDrawer
{
    ...
    private TweenExecutor[] executors = Array.Empty<TweenExecutor>();
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        {
            executors = obj.GetComponents<TweenExecutor>();
        ...
        if (target.objectReferenceValue != null)
        {
            ...
            {
                EditorGUI.LabelField(rect_two, "     ", "The target has no executors.");
            }
            else
            {
            ...
            if (index != -1 && index < executors.Length)
            {
